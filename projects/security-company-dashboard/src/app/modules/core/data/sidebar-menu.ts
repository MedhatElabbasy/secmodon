...
export const SIDEBAR_LIST: MenuItem[] = [
  {
    ...
    role: [Roles.VirtualAdmin,Roles.SecurityCompanyUser, Roles.SecuritCompany],
  },
  {
    name: 'reports',
    icon: null,
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: 'timeTrack',
        link: Routing.settings.children.TimeTrack,
        icon: 'time',
        image: null,
        role: [
          Roles.SecuritCompany,
